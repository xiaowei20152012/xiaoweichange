...
public class UsersDao extends AbstractDao<Users, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property UPic = new Property(5, String.class, "uPic", false, "U_PIC");
        public final static Property UChannel = new Property(6, String.class, "uChannel", false, "U_CHANNEL");
    };
    ...
    protected void bindValues(SQLiteStatement stmt, Users entity) {
        ...
        String uPic = entity.getUPic();
        if (uPic != null) {
            stmt.bindString(6, uPic);
        }
 
        String uChannel = entity.getUChannel();
        if (uChannel != null) {
            stmt.bindString(7, uChannel);
        }
    }
    ...
    public Users readEntity(Cursor cursor, int offset) {
        Users entity = new Users( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // uPic
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6) // uChannel
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Users entity, int offset) {
        ...
        entity.setUPic(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setUChannel(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
     }
